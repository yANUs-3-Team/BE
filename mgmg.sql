...
CREATE TABLE `Story` (
    ...
    `ending_point` INT NULL,                  -- 동화의 종료 페이지 번호
...
CREATE TABLE `Story_content` (
    ...
    `page_number`      INT NULL,                    -- 페이지 번호
    `content`          TEXT NULL,                   -- 페이지 내용
    `choice_1`         VARCHAR(255) NULL,           -- 선택지 1
    `choice_2`         VARCHAR(255) NULL,           -- 선택지 2
    `choice_3`         VARCHAR(255) NULL,           -- 선택지 3
    `choice_4`         VARCHAR(255) NULL,           -- 선택지 4
    `ai_session_id`    VARCHAR(255) NULL,           -- AI 세션 ID
    `select_choice`    INT,                         -- 선택된 선택지
